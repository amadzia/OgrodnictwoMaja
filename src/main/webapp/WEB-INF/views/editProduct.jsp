...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Zaktualizuj informacje o produkcie</p>
        </div>
        ...
        <div class="form-group">
            <label for="unitsInStock">Ilość produktów</label><form:errors path="unitsInStock"
        ...
        <a href="<c:url value="/admin/productInventory" />" class="btn btn-default">Rezygnuj</a>
        </form:form>
